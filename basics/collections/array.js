...
// let randNum = [100,99,44,2,9,12,91]
// console.log("sorted randNum:" , randNum.sort()) // sorted randNum: [ 100, 12, 2, 44, 9, 91, 99 ]

// // For numerical sort, provide a compare function

// randNum.sort(function(a, b) {
//     return a - b; // Ascending order
// });

// console.log("Numerically sorted randNum: ", randNum)                        // Numerically sorted randNum:  [ 2, 9, 12, 44, 91, 99, 100 ]

// // or
// console.log("Numerically sorted randNum: ", randNum.sort((a, b) => a - b))  // Numerically sorted randNum:  [ 2, 9, 12, 44, 91, 99, 100 ]
...
// // fillArray.fill(0)
// fillArray.fill(5, 1, 4) // fill 5 at index 1 and 2  // Filled array:  [ <1 empty item>, 5, 5, <2 empty items> ]
...
// let squaredNumbers = nums.map((item)=> {
//             return item*item
// });
// console.log("Squared Numbers: ", squaredNumbers); // Squared Numbers:  [ ... ]
...
// let num = [10, 15, 22, 33, 40, 55, 60]

// let allOdd = num.filter((item)=>{
//     return item%2 != 0
// })
// console.log("All odd numbers: ", allOdd) // All odd numbers:  [ 15, 33, 55 ]

// example to count occurrences of "Students" in an array

// let pysiders = ["Students","Mentors","Alumni","Managers","Students", "Students"]

// let newlist = pysiders.filter((item)=>{
//     return item == "Students" 
// })
// console.log("New list: ", newlist) // New list:  [ 'Students', 'Students', 'Students' ]
// console.log("Count of Students: ", newlist.length) // Count of Students:  3

// example to search string in array (case insensitive)

// const prompt = require("prompt-sync")({sigint:true})
// let searchstr = prompt("Enter string to search: ")

// let pysiders = ["Students","Mentors","Alumni","Managers","Students", "Students"]

// let result = pysiders.filter((element)=>{
//     return element.toLowerCase() == searchstr.toLowerCase()
// })

// console.log("Result: ", result)
// console.log(`Count of ${searchstr}: `, result.length)
...
//     nums.push(i)
// }
// let sumNums = nums.reduce(reducer)

// function reducer(a,b){
//     return a+b
// }
// console.log("sum of first natural number: ",sumNums)   // 55
...
// let flattenedArray = nestedArray.flat(Infinity); // to flatten any level of nesting
// console.log("Flattened array using Infinity: ", flattenedArray) // Flattened array using Infinity:  [ 1, 2, 3, 4 ]

// If no depth is specified, the default is 1
// let flattenedArray = nestedArray.flat(); 
// console.log("Flattened array with default depth: ", flattenedArray) // Flattened array with default depth:  [ 1, 2, [ 3, [ 4 ] ] ]
...
// return boolean 
// it will iterate through the iterable 
// if all the element satisfies the condition, it will return true

// let nums = [10,3,2,5,4,55]
// let nums = [10,2,4]

// let nums = [7, 14 , 21]
// let result = nums.every(element =>{
//     return element % 7 === 0
// });
// console.log("result: ",result)

// let finalRes = result ? "every num is divisible by 7": "every num is not divisible by 7"
...
// return boolean
// it will iterate through the iterable 
// if any one of the element satisfies the condition, it will return true

// const prompt = require("prompt-sync")({sigint:true})
// let item = prompt("enter element: ")
// let cart = ["mobile","tv", "shirt"]
// let result = cart.some(element => {
//     return element === item
// })

// let finalRes = result ? "item is there in your cart": "item is not there in your cart"
